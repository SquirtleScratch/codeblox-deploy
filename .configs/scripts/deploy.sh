   echo "Processing deploy.sh"
    ...
    aws elasticbeanstalk create-application-version --application-name test4321 --version-label $GITHUB_SHA --source-bundle S3Bucket=$EB_BUCKET,S3Key=codeblox.zip
